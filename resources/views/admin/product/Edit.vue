<template>
    ...
    <div>
        <div class="flex justify-between">
            <h3 class="text-2xl font-medium text-gray-700">Edit Product #{{product.id}}</h3>
            <Link :href="route('admin.products.index')" class="btn btn-primary btn-sm">
        ...
        <form @submit.prevent="submit">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-2">
                    ...
                    <div class="card-body p-4 md:p-5">
                        ...
                        <div class="border border-slate-300 mb-4">
                            ...
                            <TabGroup as="div" class="flex border-t border-slate-300" vertical>
                                <TabList as="div" class="w-1/3 flex flex-col border-r border-slate-300">
                                    ...
                                    <Tab v-slot="{ selected }" as="template">
                                        <a
                                            ...
                                            :class="[selected ? 'font-bold bg-gray-200' : 'border-slate-200']"
                                        >
                                            <mdicon name="atom" :width="15" :height="15" aria-hidden="true" /><span>Attributes</span>
                                        </a>
                                    </Tab>
                                    ...
                                    <Tab v-slot="{ selected }" as="template" v-if="form.product_type==='variable'">
                                        <a
                                            ...
                                            :class="[selected ? 'font-bold bg-gray-200' : 'border-slate-200']"
                                        >
                                            <mdicon name="atom" :width="15" :height="15" aria-hidden="true" /><span>Variations</span>
                                        </a>
                                    </Tab>
                                ...
                                <TabPanels class="w-2/3 p-2 md:p-4">
                                    ...
                                    <TabPanel>
                                        ...
                                        <div class="flex items-center mb-2">
                                            ...
                                            <div class="w-2/3">
                                                <div class="form-control mt-4">
                                                    <label class="flex items-center">
                                                        <BreezeCheckbox name="terms" v-model="form.manage_stock" :checked="form.manage_stock==1" />
                                        ...
                                        <div class="flex items-center mb-2" v-if="form.manage_stock && form.product_type != 'variable'">
                                            <div class="w-1/3">
                ...
                <div class="mt-4 rounded bg-white rounded overflow-hidden shadow-xl p-5">
                    ...
                    <button class="btn btn-primary btn-block mt-4" type="submit" :disabled="form.processing">Update</button>
...
<script>
    ...
    import { usePage, Link,Head, useForm } from '@inertiajs/inertia-vue3'
    ...
    export default {
        ...
        props: {
            ...
            attributes:Object,
            productTypes:Object,
            product_category_ids:Object,
            product_attributes:Object,
            product_variations:Object
        },
        setup(props){
            const featuredImageUrl = ref(props.product.featured_img_thumb)
            ...
            const form = useForm({
                ...
                category_id: null,
                category_ids:props.product_category_ids,
                sub_category_id:null,
                sub_category_id1:null,
                sub_category_id2:null,
                brand_id: props.product.brand_id,
                regular_price:props.product.stock.regular_price,
                sales_price:props.product.stock.sales_price,
                ...
                stock_status: props.product.product_type=='variable' ? props.product.stock_status : props.product.stock.stock_status,
                sold_individually:false,
                manage_stock: props.product.product_type=='variable' ? props.product.manage_stock : props.product.stock.manage_stock,
                stock_quantity: props.product.product_type=='variable' ? props.product.stock_quantity : props.product.stock.stock_quantity,
            ...
            onMounted(() => {
                // Load attributes
                props.product_attributes.forEach((attr)=>{
                ...
                // Load variations
                props.product_variations.forEach((variation)=>{
                    form.variations.push({
                        ...
                        attribute_code: variation.attribute_code,
                        attribute_value: variation.attribute_value
                    })
                })

                // GAllery
                props.product.media.forEach((media)=>{
                    galleryUrls.value.push(media.thumbnail_url)
                })
            });
            ...
            const addVariation = () => {
                ...
                if(attr.length) {
                    attr[0].value.forEach(function(currentValue, index){
                        let ex = form.variations.filter((v)=> v.attribute_value==currentValue && v.attribute_code==attr[0].code);
