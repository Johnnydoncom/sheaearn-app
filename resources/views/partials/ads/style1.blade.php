<div class="flexx justify-center">
    <div class="flex flex-col md:flex-row bg-white shadow-lg">
        ...
        <div class="p-6 flex flex-col justify-start">
            <h5 class="text-gray-900 text-xl font-medium mb-2 line-clamp-2"><a href="{{$ad->ads_url}}">{{$ad->title}}</a></h5>
            ...
            <div class="flex items-center justify-start gap-2">
                ...
                />
                <a href="{{$ad->ads_url}}">
                    <h5 class="text-md font-medium leading-tight">{{ $ad->author->name }}</h5>
                    <p class="text-gray-500 text-sm flex items-center gap-2">
                        ...
                        <span>{{ \Str::readDuration($ad->title, $ad->description). ' min read' }}</span></p>
                </a>
            </div>
        </div>
    </div>
