        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
            ...
            <div class="md:col-span-2">
                <x-card class="card shadow-xl">
                    <x-slot name="title"><h5 class="text-gray-900 text-xl leading-tight font-medium mb-2">Add Entry</h5></x-slot>
                    <hr>
...
{{--            <div class="mt-4">--}}
                <x-card class="card shadow-xl space-y-4">
                    ...
                    <div class="form-control">
                        ...
                        <x-select class="w-full" wire:model="category" name="category">
                    ...
                    <div class="form-control">
                        <div class="form-check form-check-inline">
                            <x-checkbox id="is-sticky" wire:model="sticky" />
                            <x-label class="form-check-label inline-block" for="is-sticky" :value="__('Sticky Entry?')" />
                        </div>
                    </div>

                    <div class="mb-4 form-control" wire:ignore>
                        <x-label for="tags" :value="__(' Tags')" />
                        <x-input.selectize wire:model="tags" name="tags[]" multiple>
                    ...
                    <div class="form-control mb-2">
                        ...
                        <x-select id="status" class="mt-1 w-full" wire:model="status"  name="status" required>
                    ...
                    <div class="form-control mb-2">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <label
                                ...
                                @elseif($entry)
                                    <img class="w-auto h-40 mx-auto" src="{{ $entry->featured_img_thumb }}" alt="Featured Image Placeholder">
                                @else
