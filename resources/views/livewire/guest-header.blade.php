    ...
    <nav x-data="{ open: false }" aria-label="Primary Menu" class="bg-white dark:bg-black w-full flex flex-wrap items-center justify-between py-1 navbar navbar-expand-lg navbar-light">
        ...
        <div class="container inline-block sticky top-0 px-0 w-full">
            <div class="navbar navbar-expand-lg navbar-light relative w-full py-4 flex flex-wrap items-center justify-between">
                ...
                <div class="absolute navbar-center inset-x-1/2 top-auto bottom-auto flex-none">
                ...
                <div class="navbar-end">
                    <ul class="hidden sm:flex menu menu-horizontal ml-auto flex-none gap-4">
                        ...
                        <li class="nav-item p-1.5">
                          <a class="nav-link text-gray-900 dark:text-gray-100 hover:text-primary focus:text-primary text-2xl font-medium" href="#">{{ __('About') }}</a>
                        </li>
                        <li class="nav-item p-1.5">
                          <a class="nav-link text-gray-900 dark:text-gray-100 hover:text-primary focus:text-primary text-2xl font-medium" href="{{ route('blog.index') }}">{{ __('Blog') }}</a>
                        </li>
                        <li class="nav-item p-1.5">
                          <a class="nav-link text-gray-900 dark:text-gray-100 hover:text-primary focus:text-primary text-2xl font-medium" href="#">{{ __('Join') }}</a>
                        </li>
                        <li class="nav-item p-1.5">
                          <a class="nav-link text-gray-900 dark:text-gray-100 hover:text-primary focus:text-primary text-2xl font-medium " href="#">{{ __('Community') }}</a>
                        </li>
                    </ul>
