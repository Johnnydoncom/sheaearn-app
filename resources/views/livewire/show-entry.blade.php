    ...
    <div class="max-w-6xl mx-auto">
        ...
        <h1 class="font-bold text-4xl sm:text-5xl py-10 text-center">{{ $entry->title }}</h1>

        <div class="flex items-center justify-center gap-4 sm:divide-x mb-10 flex-wrap sm:flex-grow">
        ...
        <div class="entry-content max-w-4xl mx-auto relative px-4">
            <div class="grid grid-cols-5 gap-4">
                <div class="col-span-5 sm:col-span-4 leading-loose text-md">
                    {!! $entry->description !!}
                </div>
