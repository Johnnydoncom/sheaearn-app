    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex items-center justify-center gap-4 mb-10 flex-wrap sm:flex-grow">
            ...
            <span class="hidden sm:block dark:text-gray-200">.</span>
                ...
                <div class="flex items-center flex-row sm:flex-col dark:text-gray-200">
                    ...
                    <div class="sticky top-0 p-5 text-gray-600" x-data="{showMoreActions: false}">
                        ...
                        <div class="floating-icons flex flex-row sm:flex-col justify-center sm:space-y-8">
                            ...
                            <button @auth wire:click="addBookmark" @else @click="showLoginModal=true" @endauth class="flex gap-2 items-center justify-center bg-white rounded-full hover:bg-gray-200 px-4 py-2 text-lg text-center">
                            ...
                            <div class="flex justify-center">
                                <div>
                                  <div class="dropstart relative">
                                    <button class="dropdown-toggle flex gap-2 items-center justify-center bg-white rounded-full hover:bg-gray-200 px-4 py-2 text-lg text-center" type="button" id="dropdownMenuButton1s" data-bs-toggle="dropdown" aria-expanded="false">
