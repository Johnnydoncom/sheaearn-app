<div class="container">
    ...
    <div class="py-0 my-0 mt-0 relative">
        <h3 class="uppercase text-xs mt-0 pt-3">Order Summary</h3>
        ...
        <div class="uppercase text-xs mt-0">
        ...
        <div strong class="card bg-white mt-0 rounded-none">
